  ...
  return (
    <div className="space-y-3">
      ...
      <div className="rounded-2xl bg-white p-4 border border-slate-200 shadow-sm">
        <div className="text-xs text-slate-500 mb-1">今月の支出</div>
        <div className="num text-3xl font-bold text-rose-600">
          {formatYen(totals.expense)}
        </div>
        <div className="mt-2 flex gap-4 text-xs">
          <div>
            <span className="text-slate-500">固定 </span>
            <span className="num font-semibold">
              {formatYen(fixedExpense)}
            </span>
          </div>
          <div>
            <span className="text-slate-500">変動 </span>
            <span className="num font-semibold">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="rounded-2xl bg-white p-3 border border-slate-200 shadow-sm">
          <div className="text-xs text-slate-500 mb-1">今月の収入</div>
          <div className="num text-xl font-bold text-emerald-600">
            {formatYen(totals.income)}
          </div>
        </div>
        <div className="rounded-2xl bg-white p-3 border border-slate-200 shadow-sm">
          <div className="text-xs text-slate-500 mb-1">収支</div>
          <div
